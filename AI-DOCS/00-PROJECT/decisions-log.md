...
| DEC-029 | Approved | Raw WordPress cPanel exports stay gitignored and are used only for one-way import; the Next.js runtime never depends on the live WordPress database. |
